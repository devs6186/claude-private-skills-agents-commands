---
name: make-plan
description: Create a detailed, phased implementation plan with documentation discovery. Use when asked to plan a feature, task, or multi-step implementation — especially before executing with the `do` skill. Enforces reading actual docs/examples before planning, preventing invented APIs.
metadata:
...
- [ ] Subagent reads: [files/URLs]
- Findings: [Allowed APIs list with sources]
- Anti-patterns to avoid: [specific things NOT to do]

### Phase 1: [Name]
- What: [specific implementation task — reference docs]
- Docs: [file:line or URL]
- Verify: [grep/test commands to confirm it worked]
- Guards: [what NOT to do]

### Phase N: Verification
- [ ] All implementations match docs
- [ ] Anti-pattern grep passes
- [ ] Tests pass
```

Pair with the `do` skill to execute the resulting plan.
