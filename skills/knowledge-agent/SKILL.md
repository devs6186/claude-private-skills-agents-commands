...
```text
build_corpus name="hooks-expertise" description="Everything about the hooks lifecycle" project="my-project" concepts="hooks" limit=500
```
...
- **Rebuild** to refresh with new observations: `rebuild_corpus name="hooks-expertise"`
- **Reprime** for fresh context: `reprime_corpus name="hooks-expertise"` (clears Q&A history)
...
Requires claude-mem plugin with `build_corpus`, `prime_corpus`, `query_corpus`, `list_corpora` MCP tools.
